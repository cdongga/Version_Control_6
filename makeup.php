...
<body>
   ...
   <header>
    ...
    <div class="banner">
    <img src="IMGM/Makeup_Banner.jpg" alt="Makeup">
    </div>
        <div class="banner-paragraph">
            <p>Discover the latest trends in makeup and find your perfect look with our wide range of products. From foundations to lipsticks, we have everything you need to enhance your beauty.</p>
        </div>
          </div>
    ...
    $sql = "SELECT * FROM products WHERE category_id = 3"; // Fetch only Makeup products
